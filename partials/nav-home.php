    ...
    <div class="home-menu pure-menu pure-menu-horizontal pure-menu-fixed <?php if (!is_page( 'Startseite' )) echo "menu-scroll" ?>">
        <div class="home-menu-wrapper">
            ...
            <div class="message mobile-nav">
                <ul>
                    <li><a href="#uber-uns" class="pure-menu-link">Über uns</a></li>
                    <li><a href="#referenzen" class="pure-menu-link">Referenzen</a></li>
                    <li><a href="#kontakt" class="pure-menu-link">Kontakt</a></li>
            ...
            <ul class="pure-menu-list">
                <li class="pure-menu-item"><a href="#uber-uns" class="pure-menu-link">Über uns</a></li>
                <li class="pure-menu-item"><a href="#referenzen" class="pure-menu-link">Referenzen</a></li>
                <li class="pure-menu-item"><a href="#kontakt" class="pure-menu-link">Kontakt</a></li>
